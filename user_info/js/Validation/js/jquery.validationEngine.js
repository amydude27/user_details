 ...
 (function($) {
	 ...
	 var methods = {
			...
			for (var i = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "equals":
						...
						break;
					case "no_equals":
						errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._no_equals);
						break;
					case "funcCall":
		...
		*/
		...
		_no_equals: function(field, rules, i, options) {
			var equalsField = rules[i + 1];
			alert(equalsField);
			//alert(field.val());
			//alert($("#" + equalsField).val());
			if (field.val() == $("#" + equalsField).val()) 
				return options.allrules.no_equals.alertText;
		},
		/**
